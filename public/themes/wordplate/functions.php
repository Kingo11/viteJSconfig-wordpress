...
add_action('wp_enqueue_scripts', function () {
    ...
    if (
        ...
        is_array(wp_remote_get('http://blog.test:5173/')) // is Vite.js running
    ) {
        wp_enqueue_script('vite', 'http://blog.test:5173/@vite/client', [], null);
        wp_enqueue_script('wordplate', 'http://blog.test:5173/resources/js/index.js', [], null);
